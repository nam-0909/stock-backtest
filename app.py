...
# ---------------------------------------------------------
# [6] 데이터베이스: 기존 원본 그대로 복원 (국내 전체 종목 & ETF DB)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# [7] 해외 통합 검색 Engine (기존 원본 그대로 복원)
# ---------------------------------------------------------
US_POPULAR_MAPPING = {
...
# ---------------------------------------------------------
# [10] 메인 분석 결과 및 개선된 3가지 선 그래프 출력
# ---------------------------------------------------------
if run_button:
    try:
        ...
        if df.empty:
            ...
            if price_series.empty:
                ...
                # ---------------------------------------------------------
                # 이중 축(Twin Axis) 적용 그래프 (원금, 평가액, 주가 3개 선)
                # ---------------------------------------------------------
