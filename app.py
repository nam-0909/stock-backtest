...
# ---------------------------------------------------------
# [1] 한글 폰트 자동 다운로드 & Matplotlib 설정 (폰트 깨짐 방지)
# ---------------------------------------------------------
@st.cache_resource
...
# ---------------------------------------------------------
# [6] 100% 통합 실시간 검색 엔진 (네이버 증권 API 연동)
# ---------------------------------------------------------
US_POPULAR_MAPPING = {
...
keyword_input = st.sidebar.text_input(
    "종목명 또는 티커 입력 (예: 삼성전자, 한화, AAPL, QQQ)",
    value=default_kw
)
